...
const DEMO_CANDIDATES: RankedCandidate[] = [
  {
    ...
    name: "Sarah Chen",
    score: 96,
    summary: "8 years React architecture + led a team of 12 at Stripe. Directly matches your senior IC + leadership requirement.",
  ...
  },
  {
    ...
    name: "Marcus Johnson",
    score: 91,
    summary: "Strong system design background with real-time data expertise. 6 years experience, solid growth trajectory.",
  ...
  },
  {
    ...
    name: "Emily Park",
    score: 84,
    summary: "Strong TypeScript skills with rapid growth. Less leadership but high ceiling. Good culture fit signals.",
  ...
  },
  {
    ...
    name: "David Kim",
    score: 72,
    summary: "Solid fundamentals, strong education. Needs more real-world scale experience.",
